...
;;
;;  This file and its companion (monogamy.nlogo) are generated from a single
...
to marry
  let suitors folk with [
    ...
    and count my-marriages < max-wives
  ]
...
The companion model is `monogamy.nlogo`. The two are generated from a single
